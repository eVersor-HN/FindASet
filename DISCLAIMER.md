...
physician, dietitian, or trainer.

- Calorie, macronutrient, weight, training, and any other figures, targets, or
  suggestions shown are **estimates for your own record-keeping** and may be
  inaccurate or incomplete.
- The **nutrition-label scanner** uses automated on-device text recognition and
  **frequently misreads values**. Always **verify scanned numbers against the
  physical label** before relying on them.
- **Exercise carries inherent risks of injury.** Train within your ability, use
  proper form and equipment, and stop if you feel unwell. Consult a professional
  before starting, changing, or intensifying any exercise or diet program,
...
**"AS IS"** and **"AS AVAILABLE"**, without warranty or guarantee of any kind
(express, implied, or statutory), including merchantability, fitness for a
particular purpose, accuracy, reliability, availability, and non-infringement.
The author does not warrant that the Software is error-free, that calculations or
recognitions are correct, or that it will operate without interruption.

## Limitation of liability

To the maximum extent permitted by applicable law, the author shall not be liable
for any indirect, incidental, special, consequential, or punitive damages, nor
for any personal injury, health consequences, loss of data, profits, or goodwill,
arising from or in connection with the Software or your use of (or inability to
use) it.

**Mandatory liability remains unaffected.** Where German law applies, nothing
here limits or excludes liability for damages arising from injury to life, body,
or health; for intent or gross negligence; under the German Product Liability Act
(Produkthaftungsgesetz); for fraudulently concealed defects; or for the culpable
breach of an essential contractual duty. See Section 8 of the [LICENSE](LICENSE)
...
create are your responsibility.
